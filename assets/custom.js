var wattagePBar = document.getElementById('wattage-pbar');
var currentPBar = document.getElementById('current-pbar');
var voltagePBar = document.getElementById('voltage-pbar');

var product = document.getElementById('product-json-product-template').textContent;
var metafields = document.getElementById('variants-metafields-json-product-template').textContent;
...
function calculatePercentage(metafields) {
  ...
  var wattagePer = setPercentage(wattages, thisWattage);
  var currentPer = setPercentage(currents, thisCurrent);
  var voltagePer = setPercentage(voltages, thisVoltage);
...
var percentages = calculatePercentage(metafields);
